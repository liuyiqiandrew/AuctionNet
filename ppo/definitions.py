...
CONFIGS_DIR = PPO_DIR / "configs"

REPO_ROOT = Path(__file__).resolve().parents[1]
# Compatibility alias used by the LLM path.
AUCTIONNET_ROOT = REPO_ROOT
RAW_DATA_DIR = REPO_ROOT / "data" / "traffic"
RL_DATA_DIR = RAW_DATA_DIR / "online_rl_data"
OUTPUT_DIR = REPO_ROOT / "output" / "ppo"
