...
Example, uniform (from the repo root):
...
# Make the repo-root packages importable when this file is run as a script.
...
from ppo.helpers import get_model_and_env_path
from ppo.online_env import EnvironmentFactory
from ppo.online_trainer import OnlineTrainer
from ppo.score_weights import (
    compute_advertiser_weights,
    compute_period_advertiser_scores,
    effective_sample_size,
)
from ppo.temporal_policy import TemporalGRUFeaturesExtractor
from ppo.weighted_env import WeightedBiddingEnv  # noqa: F401  (registers WeightedBiddingEnv-v0)
