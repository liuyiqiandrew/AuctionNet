...
# Let this file be run as `python -m ...` from the repo root or as a plain
# script from anywhere.
sys.path.insert(0, str(Path(__file__).resolve().parents[2]))

from llm.prompt import SYSTEM_PROMPT, build_user_message
from ppo.definitions import EPISODE_LENGTH, REPO_ROOT, RL_DATA_DIR, load_act_keys, load_obs_keys
from ppo.online_env import EnvironmentFactory

TRAIN_PERIODS = list(range(7, 27))  # 7..26 inclusive
VAL_PERIODS = [27]

OUT_DIR = REPO_ROOT / "data" / "llm" / "verl"
